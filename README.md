...
As PyTorch is no longer the hotness and and all ML has been replaced with infinite transdimensional monkeys
typing on keyboards, this project will no longer be maintained.
